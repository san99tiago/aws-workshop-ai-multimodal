...
def get_index():
    ...
    index = FAISS.from_embeddings(
        text_embeddings=text_embeddings, embedding=None, metadatas=metadatas
    )
...
def get_similarity_search_results(index, search_term=None, search_image=None):
    ...
    search_vector = get_multimodal_vector(
        input_text=search_term, input_image_base64=search_image_base64
    )
